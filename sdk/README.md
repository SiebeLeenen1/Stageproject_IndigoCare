...
## Prerequisites
	...
	is accessible from "RUT30X_R_GPL_00.07.14.4/scripts/dockerbuild".
...
## Building with Docker environment
	...
	2. Extract the  archive to an empty folder
		...
		$ mkdir RUT30X_R_GPL_00.07.14.4
		$ tar -xzf ~/Downloads/RUT30X_R_GPL_00.07.14.4.tar.gz -C RUT30X_R_GPL_00.07.14.4

	3. Update feeds

		$ cd RUT30X_R_GPL_00.07.14.4
	...
	5. Prepare packages for offline installation (optional)
		...
		After this you can find packages in "RUT30X_R_GPL_00.07.14.4/bin/packages/<arch_name>/zipped_packages".
...
## Installation
	...
	After successful build you will get the firmware file in
		"RUT30X_R_GPL_00.07.14.4/bin/targets/ath79/generic/tltFws".
...
## WebUI rebranding
	...
	All changes should be done in "RUT30X_R_GPL_00.07.14.4/package/feeds/vuci/vuci-ui-core/bin/dist" folder.
...
## SSH Banner
	...
	2. Use figlet tool to generate needed text:
		...
		$ figlet YOUR_TEXT > "RUT30X_R_GPL_00.07.14.4/package/base-files/files/etc/banner.logo"
...
## Default IP Change
	...
	1. Open the device family file in "RUT30X_R_GPL_00.07.14.4/target/linux/ath79/image/devices/rut3xx_family.mk"
	...
	4. Regenerate the tmpinfo files by running:
		...
		$ rm -rf "RUT30X_R_GPL_00.07.14.4/tmp"

## Default Password Change

	To change the default device password changes need to be made inside "RUT30X_R_GPL_00.07.14.4/package/base-files/files/lib/preinit/84_set_password" file.
